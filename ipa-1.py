...
def savings(gross_pay, tax_rate, expenses):
    ...
    money_left=int(gross_pay-(gross_pay*tax_rate)-expenses)
...
def interest(principal, rate, periods):
    ...
    # Replace `pass` with your code.
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    returns=principal+(principal*rate*periods)
    return(returns//1)
...
def body_mass_index(weight, height):
    ...
    # Replace `pass` with your code.
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    weight_conversion=weight*0.45359237
    height_conversion=((height[0]*12)+height[1])*0.0254
    bmi=weight_conversion/(height_conversion**2)
    return bmi
