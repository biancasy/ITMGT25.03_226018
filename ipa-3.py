...
def relationship_status(from_member, to_member, social_graph):
    ...
    #checking if from_member follows to_member
    following_list_1=social_graph[from_member]["following"]
    following_status_1=to_member in following_list_1
    #checking if to_member follows from_member
    following_list_2=social_graph[to_member]["following"]
    following_status_2=from_member in following_list_2

    if following_status_1==True and following_status_2==True:
        return "friends"
    
    if following_status_1==True and following_status_2==False:
        return "follower"
    
    if following_status_1==False and following_status_2==True:
        return "followed by"

    if following_status_1==False and following_status_2==False:
...
def tic_tac_toe(board):
    ...
    for column in range(len(board)):
        if len(set([board[row][column] for row in range(len(board))])) == 1 and board[0][column] != '':
